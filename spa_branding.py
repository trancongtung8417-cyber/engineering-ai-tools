...
# ── Tuỳ chỉnh tại đây ────────────────────────────────────────
APP_NAME      = "Green Life Spa"                          
APP_TAGLINE   = "Năng Lượng Xanh Cho Cơ Thể Khỏe Mạnh"  
LOGO_URL      = "https://i.postimg.cc/c4pdHmfB/greenlife.jpg"
PAGE_ICON     = "🌿"                            # Thay tên lửa bằng icon xây dựng
